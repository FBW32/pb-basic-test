...
const { nameOfCity, isDivisible, missingAngle, rainingToday, geometricalSequence, multiplesOfThree, powerOf, vowelCount } = require("../index");
...
describe('rainingToday', () => {
    ...
    `('Is it raining today?: if $input then $expected', ({input, expected}) => {
            expect(rainingToday(input)).toBe(expected);
        });
});
